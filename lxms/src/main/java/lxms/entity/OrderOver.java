...
public class OrderOver {
	...
	private String throughReviewed;        //等待上传 ddsc    待审核dsh     通过tg   未通过wtg
	private Long uid; //卖家	
	private UserRcertification userRcertification;  //用户验证

	public UserRcertification getUserRcertification() {
		return userRcertification;
	}
	public void setUserRcertification(UserRcertification userRcertification) {
		this.userRcertification = userRcertification;
	}
