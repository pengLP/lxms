...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx0f4493dbeca4d2b2";//微信开发平台应用id
	public static String APP_SECRET = "c0203bb790734a591fa1c3930a17cffe";//应用对应的凭证
	//应用对应的密钥
	public static String APP_KEY = "CuHDPdydCetWZJepuCWFjy4NmFjS4nN7";
	public static String PARTNER = "1377137302";//财付通商户号
	public static String PARTNER_KEY = "EjSx7w1AxJckPPGWxVasAW5Z9xVJQ94Y";//商户号对应的密钥
	...
	public static String GATEURL = "https://api.mch.weixin.qq.com/pay/unifiedorder";//获取预支付id的接口urlhttps://api.weixin.qq.com/pay/genprepay
